                        ...
                        <div className="row">
                            <div className="col appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750">
                                <div className="owl-carousel stage-margin stage-margin-md nav-style-1 nav-svg-arrows-1 nav-dark" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 2}, '768': {'items': 2}, '992': {'items': 3}, '1200': {'items': 4}}, 'autoplay': false, 'autoplayTimeout': 5000, 'autoplayHoverPause': true, 'dots': false, 'nav': true, 'loop': true, 'margin': 20, 'stagePadding': 75}">
                                    <div>
                                        <a href="demo-industry-factory-services-detail.html" className="text-decoration-none">
                                        ...
                                        <h4 className="text-center mb-0"><a href="demo-industry-factory-services-detail.html" className="text-color-dark text-color-hover-primary text-decoration-none text-2">Pastoliai</a></h4>
                                    </div>
                                    <div>
                                        <a href="demo-industry-factory-services-detail.html" className="text-decoration-none">
                                            <div className="thumb-info custom-thumb-info-style-1 mb-3">
                                        ...
                                        <h4 className="text-center mb-0"><a href="demo-industry-factory-services-detail.html" className="text-color-dark text-color-hover-primary text-decoration-none text-2">Klojiniai</a></h4>
                                    </div>
                                    <div>
                                        <a href="demo-industry-factory-services-detail.html" className="text-decoration-none">
                                            <div className="thumb-info custom-thumb-info-style-1 mb-3">
                                        ...
                                        <h4 className="text-center mb-0"><a href="demo-industry-factory-services-detail.html" className="text-color-dark text-color-hover-primary text-decoration-none text-2">Buitiniai Konteineriai</a></h4>
                                    </div>
                                    <div>
                                        <a href="demo-industry-factory-services-detail.html" className="text-decoration-none">
                                            <div className="thumb-info custom-thumb-info-style-1 mb-3">
                                        ...
                                        <h4 className="text-center mb-0"><a href="demo-industry-factory-services-detail.html" className="text-color-dark text-color-hover-primary text-decoration-none text-2">Laikinos Konstrukcijos</a></h4>
                                    </div>
                                    <div>
                                        <a href="demo-industry-factory-services-detail.html" className="text-decoration-none">
                                            <div className="thumb-info custom-thumb-info-style-1 mb-3">
                                        ...
                                        <h4 className="text-center mb-0"><a href="demo-industry-factory-services-detail.html" className="text-color-dark text-color-hover-primary text-decoration-none text-2">Transporto Paslaugos</a></h4>
                                    </div>
                                    <div>
                                        <a href="demo-industry-factory-services-detail.html" className="text-decoration-none">
                                            <div className="thumb-info custom-thumb-info-style-1 mb-3">
                                        ...
                                        <h4 className="text-center mb-0"><a href="demo-industry-factory-services-detail.html" className="text-color-dark text-color-hover-primary text-decoration-none text-2">Betonavimo Priedai</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
